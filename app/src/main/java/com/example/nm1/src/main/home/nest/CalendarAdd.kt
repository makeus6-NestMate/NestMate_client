...
class CalendarAdd : BaseActivity<ActivityCalendarAddBinding>(ActivityCalendarAddBinding::inflate) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //event
        binding.calendaraddLayoutSelect.category_random.setOnClickListener {
