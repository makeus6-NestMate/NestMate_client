...
class TodoManagerAdapter(val context: Context, private val todoList: ArrayList<Todo>, private val fragmentManager:FragmentManager):
    RecyclerView.Adapter<TodoManagerAdapter.ItemViewHolder>(){
...
//         콕 찌르기 -> 현재 시간이 정해진 시간보다 지났을때
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TodoManagerAdapter.ItemViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.layout_todo_items, parent, false)
        return ItemViewHolder(view)
    }

    override fun onBindViewHolder(holder: TodoManagerAdapter.ItemViewHolder, position: Int) {
